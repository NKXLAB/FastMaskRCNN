# Mask RCNN
Mask RCNN in TensorFlow   Python 3.5 3.6 工作正常
...
2. Download [COCO](http://mscoco.org/dataset/#download) dataset, place it into `./data`, (for how to organize the data directory, please check data/readme), then run `python download_and_convert_data.py` to build tf-records. It takes a while.
